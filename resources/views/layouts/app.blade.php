...
<html lang="en">
  <head>
    ...
    <title>SisCasa - Sistema de Monitoramento do Minha Casa Minha Vida</title>
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            <div class="toggle-nav">
                <div class="icon-reorder tooltips" data-original-title="Abrir/Fechar Menu" data-placement="bottom"><i class="icon_menu"></i></div>
            </div>

            <!--logo start-->
            <a href="{{ url('/') }}" class="logo">Sis <span class="lite">Casa</span></a>
            <!--logo end-->
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="Avatar {{ $usuario->name }}" src='{{ url("$usuario->txt_caminho_avatar")}}'>
                            </span>
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li class="eborder-top">
                                <a href='{{ url("/perfil")}}'><i class="icon_profile"></i> Meu Prefil</a>
                            </li>
                            <!-- <li>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="{{ url('/relatorios/resumo') }}">Resumo Executivo</a></li>
                      </ul>
                  </li>
				  ...
				  <li class="sub-menu">
                      <a href="javascript:;" class="">
                          ...
                          <span>Ofeta Pública</span>
                          <span class="menu-arrow arrow_carrot-right"></span>
                      </a>
                      <ul class="sub">
                          <li><a class="" href="{{ url('/oferta/protocolos') }}">Protocolos</a></li>                          
                          <li><a class="" href="form_validation.html">Pagamentos</a></li>
                      </ul>
                  </li>       
                  <!-- <li class="sub-menu">
                      <a href="javascript:;" class="">
      ...
      <!--main content start-->
      <section id="main-content" ng-app="sismcmv">
  ...
  <!-- container section end -->
    ...
    <!--Script padrão de todas as paginas-->
